# MATLAB Code for Mayotte Landslide-Tsurrogate Interface
...
The interface also use some of the routines of the TMD Matlab program that can be found under the folder code/TMD_functions: https://www.esr.org/research/polar-tide-models/tmd-software/
