...
def Landslide_Tsurrogate_psa_evaluation():
	...
	evals = surrogate_model_gauss_patterson_psa_evals(param,model,coeff,a,b,maxdeg[0])
	...
	sensi = surrogate_model_gauss_patterson_psa_sensi(coeff,maxdeg[0]-1)
...
if __name__ == '__main__':
    Landslide_Tsurrogate_psa_evaluation()
