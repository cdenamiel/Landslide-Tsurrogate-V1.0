...
print(' ')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print('Before performing the PTF:')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
...
def Landslide_Tsurrogate_step_7_PTF():
	...
	if users.is_file():
	   ...
	   if (len(a0) != nmodes) or (len(b0) != nmodes):
	      print("The defined input for PTF")
	...
	print(" ")
	print(" ---------------------------------------------------------------")
	print("PTF based on ",nw0," members produced in ",length, "seconds!")
	print(" ---------------------------------------------------------------")
	
	sio.savemat('../results/output_PTF.mat',{'PTF': PTF})
	
	print(" ")
	print("The results have been saved in: ../results/output_PTF.mat")
	print(" ")

def surrogate_model_gauss_patterson_PTF(maxdeg, a, b, coeff, nw, ar, br):
    ...
    PTF_zeta = np.exp(zeta_temp)
    PTF_velo = np.exp(velo_temp)
    PTF_time = np.exp(time_temp)
    
    return PTF_zeta, PTF_velo, PTF_time

if __name__ == '__main__':
    Landslide_Tsurrogate_step_7_PTF()
