...
print('STEP 4: Run Landslide_Tsurrogate_format_input to generate the file: ../results/output_model.mat')
print('STEP 5: Run Landslide_Tsurrogate_psa_coefficients to generate the file: ../results/output_coeff.mat')
print('STEP 6: Run Landslide_Tsurrogate_psa_evaluation to generate the files: ../results/output_evals.mat')
print('                                                                   and ../results/output_sensi.mat')
print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
print(' ')

def Landslide_Tsurrogate_visualization():
	...
	plot_hex(simu_test_z, pce_test_z,lim=60,vmax=15,xlabel='Determinisric simulations',ylabel='PSA level '+str(pm1),title='Accuracy - Maximum Tsunami Elevation')
	plot_hex(simu_test_v, pce_test_v,lim=50,vmax=40,xlabel='Deterministic simulations',ylabel='PSA level '+str(pm1),title='Accuracy - Maximum Tsunami Speed')
	plot_hex(simu_test_t, pce_test_t,lim=1750,vmax=200,xlabel='Deterministic simulations',ylabel='PSA level '+str(pm1),title='Accuracy - Tsunami Time of Arrival')
...
def plot_error(matrix, title):
    ...
    plt.xlabel('PSA Level', fontsize=14)
...
if __name__ == '__main__':
    Landslide_Tsurrogate_visualization()
