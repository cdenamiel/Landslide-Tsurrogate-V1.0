function Landslide_Tsurrogate_step_5_coefficients
...
disp(' ')
disp('------------------------------------------------------------------------------')
disp('STEP 5: generation of the deterministic coefficients of the gPCE decomposition')
disp('------------------------------------------------------------------------------')
disp(' ')
disp(' ')
disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
...
coeff = surrogate_model_gauss_patterson_coeff(param,model,a,b,maxdeg+1,option);
...
function coeff = surrogate_model_gauss_patterson_coeff(param,model,a,b,maxdeg,option)
