function Landslide_Tsurrogate_step_6_evaluation
...
evals = surrogate_model_gauss_patterson_evals(param,model,coeff,a,b,maxdeg+1);
save ../results/output_evals.mat evals
disp(' ')
disp('The results have been saved in: ../results/output_evals.mat')
disp(' ')

sensi = surrogate_model_gauss_patterson_sensi(coeff,maxdeg-1);
...
function evals = surrogate_model_gauss_patterson_evals(param,model,coeff,a,b,maxdeg)
...
function sensi = surrogate_model_gauss_patterson_sensi(coeff,maxdeg)
